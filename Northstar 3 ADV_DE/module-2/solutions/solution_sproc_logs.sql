...
-- Configure traces:
ALTER SESSION SET TRACE_LEVEL = ALWAYS;  -- After this, we are now capturing traces
...
CREATE OR REPLACE PROCEDURE staging_tasty_bytes.raw_pos.process_order_headers_stream()
  ...
  PACKAGES = ('snowflake-snowpark-python', 'snowflake-telemetry-python') -- snowflake-telemetry-python package needed to capture traces
AS
$$
